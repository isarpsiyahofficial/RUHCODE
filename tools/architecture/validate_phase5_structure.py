...
print('NOTE: this validates structural contracts only; it does not claim Android release, database implementation, migrations, rollback, or Flutter compilation are complete.')

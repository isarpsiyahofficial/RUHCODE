...
1. **Günün Mesajı — Ekim + Kasım 2027**
   - Ekim: 31 TR + 31 bağımsız EN
   - Kasım: 30 TR + 30 bağımsız EN
   - bu tur toplam **122 yeni kayıt**

2. **Contiguous editorial ledger**
   - TR `2026-01-01 → 2027-11-30` = 699
   - EN `2026-01-01 → 2027-11-30` = 699
   - toplam **1.398 / 8.036**
   - kalan **6.638**
   - sıradaki başlangıç **2027-12-01**
...
- daily messages: `2027-12-01` tarihinden TR + bağımsız EN editoryal üretime devam et

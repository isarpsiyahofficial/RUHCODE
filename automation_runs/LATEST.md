...
2. **Contiguous editorial ledger**
   - TR `2026-01-01 → 2028-03-31` = **821**
   - EN `2026-01-01 → 2028-03-31` = **821**
   - toplam **1.642 / 8.036**
   - kalan **6.394**
   - sıradaki başlangıç **2028-04-01**
...
- daily messages: `2028-04-01 → 2028-04-30` TR + bağımsız EN editoryal üretim

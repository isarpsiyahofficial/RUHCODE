...
1. **Günün Mesajı — Ocak + Şubat 2034**
   - Ocak: 31 TR + 31 bağımsız EN
   - Şubat: 28 TR + 28 bağımsız EN
   - bu tur toplam **118 yeni kayıt**
   - iki locale için exact yeni tarih aralığı `2034-01-01 → 2034-02-28`

2. **Contiguous editorial ledger**
   - TR `2026-01-01 → 2034-02-28` = **2981**
   - EN `2026-01-01 → 2034-02-28` = **2981**
   - toplam **5962 / 8036**
   - kalan **2074**
   - sıradaki başlangıç **2034-03-01**
...
- daily messages: `2034-03-01` tarihinden itibaren TR + bağımsız EN

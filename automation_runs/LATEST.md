...
1. **Günün Mesajı — Mart + Nisan 2029**
   - 61 TR + 61 bağımsız EN
   - bu tur toplam **122 yeni kayıt**

2. **Contiguous editorial ledger**
   - TR `2026-01-01 → 2029-04-30` = **1216**
   - EN `2026-01-01 → 2029-04-30` = **1216**
   - toplam **2432 / 8036**
   - kalan **5604**
   - sıradaki başlangıç **2029-05-01**
...
- daily messages: `2029-05-01 → 2029-05-31` TR + bağımsız EN editoryal üretim
